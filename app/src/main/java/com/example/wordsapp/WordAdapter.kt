...
class WordAdapter(private val letterId: String, context: Context) :
    ...
    init {
        ...
        filteredWords = words
            ...
            // dalam hal ini jika item dimulai dengan huruf yang diberikan,
            // mengabaikan UPPERCASE atau huruf kecil.
            .filter { it.startsWith(letterId, ignoreCase = true) }
            // Mengembalikan koleksi yang telah diacak di tempatnya
            .shuffled()
            // Mengembalikan n item pertama sebagai [Daftar]
            .take(5)
            // Mengembalikan versi yang diurutkan dari [Daftar]
            .sorted()
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WordViewHolder {
        ...
        // Siapkan delegasi aksesibilitas khusus untuk mengatur pembacaan teks
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        // Atur teks WordViewHolder
        holder.button.text = item

        // Memanggil setOnClikListener() di tombol
        holder.button.setOnClickListener {

            // Penggunaan parse() untuk membuat URI dari String
            // Menambahkan kata ke SEARCH_PREFIX menggunakan pemformatan string
            // Inisialisasi objek intent
    ...
    companion object Accessibility : View.AccessibilityDelegate() {
        ...
        override fun onInitializeAccessibilityNodeInfo(
            ...
            // itu mengumumkan "ketuk dua kali ke <string kustom>".
